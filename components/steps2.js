            ...
            <div className="steps2-container3">
              <div className="steps2-container4 thq-card">
                <h2>
                  {props.step1Title ?? (
                    <Fragment>
                      <h2 className="steps2-text25 thq-heading-2">Step 1</h2>
                    </Fragment>
                  )}
                </h2>
                <span>
              ...
              <div className="steps2-container5 thq-card">
                <h2>
                  {props.step2Title ?? (
                    <Fragment>
                      <h2 className="steps2-text28 thq-heading-2">Step 2</h2>
                    </Fragment>
                  )}
                </h2>
                <span>
              ...
              <div className="steps2-container7 thq-card">
                <h2>
                  {props.step4Title ?? (
                    <Fragment>
                      <h2 className="steps2-text31 thq-heading-2">Step 4</h2>
                    </Fragment>
                  )}
                </h2>
                <span>
